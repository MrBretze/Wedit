...
public class PlayerControllerMP
{
    ...
    public boolean onPlayerDestroyBlock(BlockPos pos)
    {
         ...
         * Wedit start
         */
        if (this.currentGameType.isCreative() && this.mc.player.getHeldItemMainhand().getItem() == Items.GOLDEN_SWORD)
        {
            Wedit.setFirstPosition(pos);
            return false;
        }
        /**
         * Wedit end
         */
        else if (this.currentGameType.isCreative() && !this.mc.player.getHeldItemMainhand().func_190926_b() && this.mc.player.getHeldItemMainhand().getItem() instanceof ItemSword)
        {
            return false;
        }
        else
    ...
    public EnumActionResult processRightClick(EntityPlayer player, World worldIn, EnumHand stack)
    {
         ...
         * Wedit start
         */
        if (this.currentGameType == GameType.CREATIVE && player.getHeldItemMainhand().getItem() == Items.GOLDEN_SWORD && this.mc.objectMouseOver.getBlockPos() != null)
        {
            Wedit.setSecondPosition(this.mc.objectMouseOver.getBlockPos());
            return EnumActionResult.PASS;
        }
